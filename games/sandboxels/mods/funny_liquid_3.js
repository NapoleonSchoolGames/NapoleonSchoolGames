...
runAfterLoad(function() {
  if (enabledMods.includes("mods/funny_liquid.js")) {
  ...
  if (foodArray) {
    for (i = 0; i < foodArray.length; i++) {
      elements.vomit.reactions[foodArray[i]] = {
        elem1: ["vomit", "vomit", "vomit", "vomit", "vomit", null, null],
        elem2: [foodArray[i], null],
        chance: 0.6
      }
    }
  }
  ...
  if (enabledMods.includes("mods/fey_and_more.js")) {
    ...
    elements.concoction.reactions.vomit = {
        "elem1": "mistake",
        "elem2": null
      },
      elements.concoction.reactions.frozen_vomit = {
        "elem1": "mistake",
        "elem2": null
      },
      elements.concoction.reactions.vomit_snow = {
        "elem1": "mistake",
        "elem2": null
      },

      elements.fairy.reactions.vomit = {
        "elem1": "vomit_fairy"
      }
    elements.vomit.reactions.fairy = {
      "elem2": "vomit_fairy"
    }
