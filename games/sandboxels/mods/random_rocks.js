...
if (enabledMods.includes(libraryMod)) {
  if (urlParams.get('rockAmount') != null) {
    rockAmount = urlParams.get('rockAmount')
    if (isNaN(rockAmount) || rockAmount === "" || rockAmount === null) {
      rockAmount = 10
    }
  ...
  if (urlParams.get('makeRockString') !== null) {
    makeRockString = true
  } else {
    makeRockString = false
  }

  const initialArrayR = ["m", "n", "p", "t", "ch", "k", "b", "d", "j", "g", "f", "th", "s", "sh", "h", "l", "r", "y", "w", "z", "sp", "st", "sk", "sl", "spl", "stl", "skl", "sr", "spr", "str", "skr", "sl", "fl", "fr", "pl", "pr", "tl", "tr", "kl", "kr", "shr", "fl", "fr", "thr"]
  const vowelArrayR = ["a", "e", "i", "o", "u", "ay", "ee", "ie", "oa", "ew", "oo", "oi", "ow"]
  const medialArrayR = ["m", "n", "p", "t", "k", "b", "d", "g", "f", "th", "s", "sh", "h", "l", "r", "y", "z", "sp", "st", "sk", "sl", "spl", "stl", "skl", "sr", "spr", "str", "skr", "sl", "fl", "fr", "pl", "pr", "tl", "tr", "kl", "kr", "shr", "fl", "fr", "thr"]
  const finalArrayR = ["m", "n", "p", "t", "k", "b", "d", "g", "f", "th", "s", "sh", "l", "r", "y", "z", "sp", "st", "sk", "sl", "spl", "stl", "skl", "sr", "spr", "str", "skr", "pl", "pr", "tl", "tr", "bl", "vr"]
