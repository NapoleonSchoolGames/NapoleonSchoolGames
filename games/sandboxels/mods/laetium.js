function splitRgbColor(color) {
  ...
  elements.beta_atisanium = {
    color: "#750e35",
    conduct: Infinity,
    colorOn: ["#0f0021", "#120324", "#4b106e", "#a6058e", "#42043a"],
    tempHigh: -260,
  ...
  elements.polusium = {
    ...
    reactions: {
      water: {
        elem1: "polusium_oxide",
        elem2: ["water", "water", "water", "water", "hydrogen"],
        chance: 0.006
      },
      salt_water: {
        elem1: "polusium_oxide",
        elem2: ["salt_water", "salt_water", "salt_water", "salt", "hydrogen"],
        chance: 0.012
      },
      bleach: {
        elem1: "polusium_oxide",
