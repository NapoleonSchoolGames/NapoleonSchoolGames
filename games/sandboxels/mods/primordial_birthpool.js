runAfterLoad(function() {
	if (enabledMods.includes("mods/fey_and_more.js")) {
	  elements.primordial_birthpool = {
		...
		reactions: {
		  "cancer": {
			"elem1": ["toxic_mistake", "dirty_water"]
		  },
		  "cyanide": {
			"elem1": ["toxic_mistake", "dirty_water"]
		  },
		...
		reactions: {
		  concoction: {
			"elem1": ["primordial_soup", "birthpool", "primordial_birthpool"],
			"elem2": ["primordial_soup", "birthpool", "primordial_birthpool"],
			"chance": 0.0045
		  },
		},
	  };
	  ...
	  elements.birthpool.reactions.primordial_soup = {
		"elem1": "primordial_birthpool",
		"elem2": "primordial_birthpool"
	  }
	};
  });