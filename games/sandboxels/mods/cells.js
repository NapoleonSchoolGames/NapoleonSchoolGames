goldObject = {
  ...
  if (urlParams.get('goldFairyAmount') != null) {
	goldFairyAmount = urlParams.get('goldFairyAmount')
	if (isNaN(goldFairyAmount) || goldFairyAmount === "" || goldFairyAmount === null) {
	  goldFairyAmount = 10
	}
  ...
  elements.cell_2 = {
	...
	reactions: {
	  ...
	  "poison": {
		"elem1": [null, null, "poison", "poison", "poison", "dna", "dirty_water"],
		"chance": 0.03
	  },
	  "proton": {
		"elem1": [null, "cancer"],
  ...
  runAfterLoad(function() {
	if (enabledMods.includes("mods/fey_and_more.js")) {
	  ...
	  elements.fairy.reactions.gold = {
		elem1: "gold_fairy",
		"elem2": null
	  };
	  elements.fairy.reactions.gold_coin = {
		elem1: "gold_fairy",
		"elem2": null
	  };
	  ...
	  elements.gold.reactions.fairy = {
		elem1: null,
		elem2: "gold_fairy"
	  };
	  elements.gold_coin.reactions.fairy = {
		elem1: null,
		elem2: "gold_fairy"
	  };
	  ...
	  for (var i = 2; i <= goldFairyAmount + 1; i++) {
		...
		if (i == goldFairyAmount) {
		  elements[`gold_${i}-fairy`]["reactions"] = {};
		}
	  }
	...
	elements.rainbow.reactions.gold_fairy = {
	  "elem1": "gold_2-fairy",
	  "elem2": null
	}
  });