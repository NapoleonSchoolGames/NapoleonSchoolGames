elements.shit = {
    ...
    reactions: {
      "fly": {
        "elem1": "fly",
        "elem2": [null, null, null, null, null, null, "fly"],
        "chance": 0.02,
      },
    },
    tempHigh: 100,
  ...
  elements.dried_shit = {
    ...
    reactions: {
      "fly": {
        "elem1": "fly",
        "elem2": [null, null, null, null, null, null, null, "fly"],
        "chance": 0.004,
      },
    },
    category: "shit",
  ...
  elements.water.reactions.shit = {
    "elem1": ["shit", "shit", "diarrhea"],
    "elem2": ["dirty_water", "dirty_water", null]
  }
elements.water.reactions.dried_shit = {
  "elem1": "shit",
  "elem2": ["water", "dirty_water", "water", "dirty_water", null]
}
elements.water.reactions.diarrhea = {
  "elem1": "diarrhea",
  "elem2": "dirty_water"
}
...
runAfterLoad(function() {
  ...
  if (enabledMods.includes("mods/fey_and_more.js")) {
    ...
    elements.concoction.reactions.shit = {
        "elem1": "mistake",
        "elem2": null
      },
      elements.concoction.reactions.dried_shit = {
        "elem1": "mistake",
        "elem2": null
      },
      elements.concoction.reactions.diarrhea = {
        "elem1": "mistake",
        "elem2": null
      },
      elements.concoction.reactions.frozen_shit = {
        "elem1": "mistake",
        "elem2": null
      },
      elements.concoction.reactions.frozen_diarrhea = {
        "elem1": "mistake",
        "elem2": null
      },

      elements.fairy.reactions.shit = {
        "elem1": "shit_fairy"
      }
