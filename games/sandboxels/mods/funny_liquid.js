elements.cum = {
    ...
    reactions: {
      ...
      "acid": {
        "elem1": "water",
        "elem2": ["cum_water", "dead_cum_water", "dead_cum_water", "dead_cum_water", "dead_cum_water"],
        "chance": 0.1
      },
      "slime": {
        "elem1": "water",
  ...
  elements.cum_water = {
    ...
    reactions: {
      ...
      "salt_water": {
        "elem1": ["dead_cum_water", "salt_water"],
        "elem2": ["dead_cum_water", "salt_water"]
      },
      "acid": {
        "elem1": ["acid", "water"],
        "elem2": "water"
  ...
  elements.cum_ice = {
    ...
    reactions: {
      "acid": {
        "elem1": "water",
        "elem2": ["cum_water_ice", "dead_cum_water_ice", "dead_cum_water_ice", "dead_cum_water_ice", "dead_cum_water_ice"]
      },
      "alcohol": {
        "elem1": "alcohol",
        "elem2": "dead_cum_ice"
...
elements.precum = {
    ...
    reactions: {
      "acid": {
        "elem1": "water",
        "elem2": ["precum", "precum", "precum", "precum", "precum", "precum", "precum", "water", "water", "water"]
      },
    },
    tempLow: 0,
    stateLow: "precum_ice",
  ...
  elements.precum_ice = {
    ...
    reactions: {
      "acid": {
        "elem1": "water",
        "elem2": ["precum_ice", "precum_ice", "precum_ice", "precum_ice", "precum_ice", "precum_ice", "precum_ice", "ice", "ice", "ice"]
      },
    },
    viscosity: 20,
    temp: -5,
  ...
  elements.precum_snow = {
    ...
    reactions: {
      "acid": {
        "elem1": "water",
        "elem2": ["precum_snow", "precum_snow", "precum_snow", "precum_snow", "precum_snow", "precum_snow", "precum_snow", "water", "water", "water"]
      },
    },
    temp: -5,
    tempHigh: 0,
...
elements.fly.reactions.cum = {
  "elem1": "fly",
  "elem2": null
}
elements.frog.reactions.cum = {
  "elem1": "cum_water",
  "elem2": "frog"
}
elements.ant.reactions.cum = {
  "elem1": "ant",
  "elem2": null
}
elements.fish.reactions.cum = {
  "elem1": "fish",
  "elem2": "cum_water"
}
elements.fish.reactions.cum_water = {
  "elem1": "fish",
  "elem2": "water"
}
elements.fish.reactions.dead_cum = {
  "elem1": "fish",
  "elem2": "dead_cum_water"
}
elements.fish.reactions.dead_cum_water = {
  "elem1": "fish",
  "elem2": "water"
}
elements.cell.reactions.cum = {
  "elem1": "cum",
  "chance": 0.01
}
...
runAfterLoad(function() {
  ...
  if (enabledMods.includes("mods/fey_and_more.js")) {
    ...
    elements.concoction.reactions.cum = {
        "elem1": "mistake",
        "elem2": null
      },
      elements.concoction.reactions.cum_water = {
        "elem1": "mistake",
        "elem2": null
      },
      elements.concoction.reactions.cum_ice = {
        "elem1": "mistake",
        "elem2": null
      },
      elements.concoction.reactions.cum_snow = {
        "elem1": "mistake",
        "elem2": null
      },
      elements.concoction.reactions.precum = {
        "elem1": "mistake",
        "elem2": null
      },
      elements.concoction.reactions.precum_ice = {
        "elem1": "mistake",
        "elem2": null
      },
      elements.concoction.reactions.precum_snow = {
        "elem1": "mistake",
        "elem2": null
      },
      elements.concoction.reactions.cummy_ice = {
        "elem1": "mistake",
        "elem2": null
      },
      elements.concoction.reactions.dead_cum = {
        "elem1": "mistake",
        "elem2": null
      },
      elements.concoction.reactions.dead_cum_water = {
        "elem1": "mistake",
        "elem2": null
      },
      elements.concoction.reactions.dead_cum_ice = {
        "elem1": "mistake",
        "elem2": null
      },
      elements.concoction.reactions.dead_cum_snow = {
        "elem1": "mistake",
        "elem2": null
      },
      elements.concoction.reactions.dead_cummy_ice = {
        "elem1": "mistake",
        "elem2": null
      },
      elements.concoction.reactions.cummy_mud = {
        "elem1": "mistake",
        "elem2": null
      },
      elements.concoction.reactions.cummy_sand = {
        "elem1": "mistake",
        "elem2": null
      },
      elements.concoction.reactions.cummy_permafrost = {
        "elem1": "mistake",
        "elem2": null
      },
      elements.concoction.reactions.dead_cummy_mud = {
        "elem1": "mistake",
        "elem2": null
      },
      elements.concoction.reactions.dead_cummy_sand = {
        "elem1": "mistake",
        "elem2": null
      },
      elements.concoction.reactions.dead_cummy_permafrost = {
        "elem1": "mistake",
        "elem2": null
      },
      elements.concoction.reactions.burnt_cum = {
        "elem1": "mistake",
        "elem2": null
      },
      elements.concoction.reactions.cum_slime = {
        "elem1": "mistake",
        "elem2": null
      },
      elements.concoction.reactions.cummy_snake = {
        "elem1": "mistake",
        "elem2": null
      },
      elements.concoction.reactions.penis = {
        "elem1": "mistake",
        "elem2": null
      }
    elements.concoction.reactions.cum_bomb = {
      "elem1": "mistake",
      "elem2": null
    }

    elements.fairy.reactions.cum = {
      "elem1": "cum_fairy"
    }
