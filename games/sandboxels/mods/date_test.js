...
if (enabledMods.includes(haseuliteMod)) {
  ...
  idolData = {
    ...
    "01-02": {
      member: "Jihyo",
      color: "rgb(250,200,87)",
      group: "Twice"
    },
    "03-02": [{
        member: "Rei",
        color: "rgba(105,195,45)",
        group: "IVE"
      },
      {
        member: "Gong Yubin",
    ...
    "24-03": {
      member: "Mina",
      color: "rgb(111,197,194)",
      group: "Twice"
    },
    "12-04": {
      member: "Jeong Hyerin",
      color: "rgb(142,108,255)",
      group: "tripleS"
    },
    "14-04": {
      member: "Yoon",
    ...
    "03-10": {
      member: "Kim Soomin",
      color: "rgb(236,138,165)",
      group: "tripleS"
    },
    "13-10": [{
        member: "Kim Nakyoung",
        color: "rgb(101,153,164)",
        group: "tripleS"
      },
      {
        member: "Park Sohyun",
    ...
    "09-11": {
      member: "Momo",
      color: "rgb(248,207,215)",
      group: "Twice"
    },
    "11-11": {
      member: "YeoJin",
      color: "rgb(244,111,31)",
      group: "Loona"
    },
    "12-11": {
      member: "Xiaoting",
  ...
  for (date in idolData) {
    ...
    if (!(idolData[date] instanceof Array)) {
      idolData[date] = [idolData[date]]
    };
  ...
  runAfterAutogen(function() {
    ...
    if (idolData[dayMonth]) {
      ...
      for (var memberIndex = 0; memberIndex < data.length; memberIndex++) {
        ...
        shuffleArray(randomElementSets[member]);
        randomElementSets[member] = randomElementSets[member].slice(0, shortenedTest ? 2 : 12);
  ...
  if (!enabledMods.includes(haseuliteMod)) {
    enabledMods.splice(enabledMods.indexOf(modName), 0, haseuliteMod)
  };
