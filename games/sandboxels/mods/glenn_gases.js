elements.coal_dust = {
  ...
  elements.torch.reactions.black_damp = {
	elem1: "wood"
  }
  ...
  runAfterLoad(function() {
	...
	for (i = 0; i < lifeArray.length; i++) {
	  elements.void_gas.reactions[lifeArray[i]] = {
		"elem2": null,
		"chance": 0.7
	  }
	};
	for (i = 0; i < lifeArray.length; i++) {
	  elements.black_damp.reactions[lifeArray[i]] = {
		"elem2": null,
		"chance": 0.7
	  }
	};
